...
export default class Robots {
    robotsCache;
    opts: typeof DFLT_OPTS;
    active: any;

    constructor(opts: typeof DFLT_OPTS = DFLT_OPTS) {
        this.robotsCache = {};
        this.opts = {
    ...
    fetch(link) {
        ...
        return getRobots(robotsLink, this.opts.timeout).then((data) => {
