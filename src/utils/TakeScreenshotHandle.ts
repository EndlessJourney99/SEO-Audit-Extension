        ...
        ***************************************************************************** */ var r =
        ...
        function t(A, e, t) {
            if (t || 2 === arguments.length)
                for (var r, B = 0, n = e.length; B < n; B++)
                    (!r && B in e) ||
                        ((r = r || Array.prototype.slice.call(e, 0, B))[B] =
                            e[B]);
            return A.concat(r || e);
        }
        var d =
        ...
        var HA = { type: 2 },
            ...
            PA =
                ...
                (XA.prototype.consumeUrlToken = function () {
                    var A = [];
                    if (
                        (this.consumeWhiteSpace(), -1 === this.peekCodePoint(0))
                    )
        ...
        function gr(A, e) {
            (this.animationDuration = lr(A, nr, e.animationDuration)),
                ...
                (this.borderBottomLeftRadius = lr(
                    A,
                    Bt,
            ...
            (this.overflowX = t[0]),
                ...
                (this.webkitTextStrokeColor = lr(
                    A,
                    Qr,
                    e.webkitTextStrokeColor
                )),
                (this.webkitTextStrokeWidth = lr(
                    A,
                    cr,
            ...
            Yr = function (A, e) {
                ...
                if (t) {
                    ...
                    if (t) {
                        ...
                        A = f(A, r);
                        return (
                            r.firstChild && t.replaceChild(r.firstChild, r), A
                        );
                    }
                }
                return d.EMPTY;
                                ...
                                ? Xr.SUPPORT_RANGE_BOUNDS
                                    ? 1 <
                                      (r = Wr(s, i, A.length).getClientRects())
                                        ...
                                        : o.push(
                                              new Jr(A, d.fromDOMRectList(B, r))
                                          )
        ...
        var gn,
            ...
            ln = {
                integers: [
                    ...
                    200, 100, 90, 80, 70, 60, 50, 40, 30, 20, 19, 18, 17, 16,
            ...
            Cn = {
                integers: [
                    ...
                    700, 600, 500, 400, 300, 200, 100, 90, 80, 70, 60, 50, 40,
        ...
        var jn =
            ((zn.prototype.subdivide = function (A, e) {
                var t = qn(this.start, this.startControl, A),
                    ...
                    A = qn(n, r, A);
                return e
                    ? new zn(this.start, t, n, A)
                    : new zn(A, r, B, this.end);
            }),
        ...
        var Ls,
            ...
            bs =
                    ...
                    return a(this, void 0, void 0, function () {
                        return H(this, function (A) {
                            switch (A.label) {
                                ...
                                case 1:
                                    return (
                                        A.sent(), [4, this.renderNodeContent(e)]
                                    );
                                case 2:
                                    A.sent(), (A.label = 3);
                                case 3:
                            ...
                            switch (A.label) {
                                ...
                                case 14:
                                    ...
                                    if (null === e.styles.listStyleImage)
                                        return [3, 19];
                                    if (
                                        0 !== (c = e.styles.listStyleImage).type
                                    )
                                        return [3, 18];
                        ...
                        return H(this, function (A) {
                            switch (A.label) {
                                ...
                                case 5:
                                    return [
                                        4,
                                        this.renderNodeContent(C.element),
                                    ];
                                case 6:
                                    A.sent(),
                                        (r = 0),
                ...
                (Ds.prototype.renderDashedDottedBorder = function (
                    g,
                    w,
                    U,
                    l,
...
function ByPassCORSImgs(cloneDoc){
    const allImgTags = cloneDoc.querySelectorAll("img").filter()
}